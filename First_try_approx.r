...
donor_total_reads <- matrix( 0, n_variants, 1)

donor_var_reads_true  <- matrix( 0, n_variants, 1)

donor_var_reads_observed <- matrix( 0, n_variants, 1)
...
recipient_var_reads_observed <- matrix( 0, n_variants, 1)
...
#log_likelihood_function <- matrix( 0, (Nb_max -Nb_min + 1))
